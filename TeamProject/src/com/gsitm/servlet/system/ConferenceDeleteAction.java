	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(password.equals(employPwd)){
			try{
				 ...
				 out.println("<script type='text/javascript'>alert('회의실 미사용 처리가 완료 되었습니다.');");
				 out.println("location.href='../conference/manageaction';</script>"); //
				 System.out.println("회의실 미사용 성공");
			}catch(Exception e){
				out.println("<script type='text/javascript'>alert('회의실 미사용 처리가 실패하였습니다.\\n" +
