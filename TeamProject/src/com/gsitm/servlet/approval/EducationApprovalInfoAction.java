	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(password.equals(employPwd)){
			...
			try{
		        ...
		        (new MailSender()).send( requestUser, "사용승인", regInId);
		        out.println("<script type='text/javascript'>alert('승인 처리가 완료 되었습니다.');");
			    out.println("location.href='../../education/approval';</script>"); //
				System.out.println("승인 완료 성공");
			}catch(Exception e){
				out.println("<script type='text/javascript'>alert('승인 처리가 실패하였습니다.\\n" +
			...
			System.out.println("관리자 최종 승인 완료 실패");
		}
