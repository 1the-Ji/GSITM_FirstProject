...
<body style="text-align: center;">
	...
	<br/>
	<a href="${btnUrl}" target="__blank" style="display: inline-block;width: 200px;padding: 10px 15px;text-decoration: none;background-color: #538cc6;color: #fff;box-shadow: 1px 1px 3px #ccc;font-size: 12pt;font-weight: bold;border-style: none;">${btnText}</a>
</body>
</html>