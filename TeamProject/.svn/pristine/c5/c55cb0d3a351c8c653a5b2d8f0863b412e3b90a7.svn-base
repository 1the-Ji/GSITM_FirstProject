<%--
	...
	since   : 2017. 5. 5.
	version : 1.0
	subject : 예약 요청된 회의실들을 관리하기 위한 화면
	description : 회의실 담당자가 예약 요청된 회의실에 대해서 결재승인 및 반려를 하기위한 폼
--%>
...
<html>
	...
	<body>
		...
		<table>
			...
			<form method="post" action="../conference/approval/info">
			...
			<form method="post" action="../conference/approval/reject">
